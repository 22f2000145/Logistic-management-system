...
with app.app_context():
    ...
    if not app.security.datastore.find_user(email='admin01@admin.com'):
        app.security.datastore.create_user(email = 'admin01@admin.com', 
                                           username='admin01', 
                                           password=hash_password('1234'), 
                                           roles=['admin'])

    if not app.security.datastore.find_user(email ='user01@user.com'):
        app.security.datastore.create_user(email = 'user01@user.com', 
                                           username='user01',
                                           password=hash_password('1234'), 
                                           roles=['user'])
